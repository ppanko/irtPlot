...

{
    ...
    if(model == "grm") {
        ...
        if(type == "icc") {
            ...
            plPlot <- list()
            for(i in 1:length(pdt)) plPlot[[i]] <- plotThings(pdt[[i]], ttl = title2[i], ylbs = ylb)
        ...
        if(type == "iif") {
            ...
            plPlot <- list()
            for(i in 1:length(pdt)) plPlot[[i]] <- plotThings(rdt1[[i]], ttl = title2[i], ylbs = ylb)
            ...
            plPlot <- list()
            for(i in 1:length(pdt)) plPlot[[i]] <- plotThings(odt1[[i]], ttl = title2[i], ylbs = ylb)
