...
- *itmNam*: A vector of character string specifying the name of the items displayed in the legend. Default values are the names of the columns in the specified data set. 
